...
const mcp = new Server(
  { name: 'telegram-unleashed', version: '1.1.0' },
  {
    ...
    instructions: [
      ...
      '',
      'Messages arrive as <channel source="telegram" chat_id="..." message_id="..." user="..." ts="...">. If the tag has image_path, Read that file. If it has attachment_file_id, call download_attachment with that id, then Read the returned path.',
      '',
      ...
      '',
      'The activity indicator starts automatically on every inbound message and is kept alive until you send something, so the user always knows you are working. For a long answer, prefer stream_start / stream_push / stream_end — the user watches it appear instead of waiting.',
      '',
      ...
      '',
      'Telegram exposes no history or search — you only see messages as they arrive. If you need earlier context, ask the user to paste it.',
      '',
